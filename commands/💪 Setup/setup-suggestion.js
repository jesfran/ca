  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      client.settings.ensure(message.guild.id, {
        suggest: {
          channel: "",
          approvemsg: `<a:yes:933036759913201725> Accepted Idea! Expect this soon.`,
          denymsg: `<:emojino:933030632731340872> Thank you for the feedback, but we are not interested in this idea at this time.`,
