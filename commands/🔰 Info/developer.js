...
module.exports = {
	...
	run: async (client, message, args, cmduser, text, prefix) => {
		...
		try {	
			let button_public_invite = new MessageButton().setStyle('LINK').setLabel(client.la[ls].cmds.info.developer.buttons.invite).setURL("https://discord.com/api/oauth2/authorize?client_id=935935328966045768&permissions=8&scope=bot%20applications.commands")
			...
			message.reply({embeds: [new MessageEmbed()
				...
				.setURL("https://discord.gg/BVTuGNFfXh")
				.addField("🆕 Si wey soy yo", `> <@!326964325346443266>`)
