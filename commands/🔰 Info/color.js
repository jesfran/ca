  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    let ls = client.settings.get(message.guild.id, "language")
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<:arrow:933397939114623096> **Name**', "```"+json.name+"```", true)
        .addField("<:arrow:933397939114623096> **Hex**",  "```"+json.hex+"```", true)
        .addField("<:arrow:933397939114623096> **RGB**",  "```"+json.rgb+"```", true)
        .addField(`<:arrow:933397939114623096> **${client.la[ls].cmds.info.color.brightershade}**`,  "```"+json.brightened +"```", true)
