...
module.exports = {
    ...
    let es = client.settings.get(message.guild.id, "embed");let ls = client.settings.get(message.guild.id, "language")
		...
		try{
      let milratodc = client.guilds.cache.get("933765792397414480")
      let milratomembers = await milratodc.members.fetch().catch(() => {});
      let partnercount = milratomembers.filter(m => m.roles.cache.has("933766481404104817"))
      ...
      .setColor(es.color)
      .setAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://discord.gg/BVTuGNFfXh")
...
/**
  * @INFO
  * Bot Coded by Tomato#6966 | https://discord.gg/BVTuGNFfXh
  * @INFO
