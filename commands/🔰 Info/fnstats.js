  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      try{
        ...
        let themsg = await message.reply(`<a:Loading:936892036307648552> Getting the Fortnite Stats of ${Epic}`)
        const stats = new Canvas.FortniteStats()
        const image = await stats.setToken("b58b803d-a911-4b17-a9b2-24b21c7412b0")
          .setUser(Epic)
