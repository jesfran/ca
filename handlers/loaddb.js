...
module.exports = client => {
    ...
    console.log(`${String("[x] :: ".blue)}Ahora cargando la base de datos...`.brightGreen)
...
/*
    ...
    console.log(`[x] :: `.blue + `CARGADO LAS BASES DE DATOS después: `.brightGreen + `${Date.now() - dateNow}ms`.green)
}