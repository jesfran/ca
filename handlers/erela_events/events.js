...
let skip = new MessageButton().setStyle('PRIMARY').setCustomId('1').setEmoji(`937783970098204764`).setLabel(`Siguiente`)
let stop = new MessageButton().setStyle('DANGER').setCustomId('2').setEmoji(`937782078676807771`).setLabel(`Detener`)
let pause = new MessageButton().setStyle('SECONDARY').setCustomId('3').setEmoji('937783972971307039').setLabel(`Pausa`)
let autoplay = new MessageButton().setStyle('SUCCESS').setCustomId('4').setEmoji('937783971985645708').setLabel(`Auto-reproducción`)
let shuffle = new MessageButton().setStyle('PRIMARY').setCustomId('5').setEmoji('937783973940179024').setLabel(`Barajar`)
if (!player.playing) {
...
let songloop = new MessageButton().setStyle('SUCCESS').setCustomId('6').setEmoji(`937783971985645708`).setLabel(`Cancion`)
let queueloop = new MessageButton().setStyle('SUCCESS').setCustomId('7').setEmoji(`937783971985645708`).setLabel(`Cola`)
let forward = new MessageButton().setStyle('PRIMARY').setCustomId('8').setEmoji('937783970098204764').setLabel(`+10 seg`)
let rewind = new MessageButton().setStyle('PRIMARY').setCustomId('9').setEmoji('937783971239055481').setLabel(`-10 seg`)
let lyrics = new MessageButton().setStyle('PRIMARY').setCustomId('10').setEmoji('937783975408181299').setLabel(`letra`).setDisabled();
