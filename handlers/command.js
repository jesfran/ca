...
console.log("Bienvenido al sistema de inicio del bot en Tiempo aprox de inicio 5 segundos ,  porfavor espera un poco".blue);
module.exports = (client) => {
  let dateNow = Date.now();
  console.log(`${String("[x] :: ".blue)}Ahora cargando los comandos ...`.brightGreen)
  try {
  ...
  console.log(`[x] :: `.blue + `Cargando los ${client.commands.size} Comandos despues de: `.brightGreen + `${Date.now() - dateNow}ms`.green)
};
/**
 * @INFO
